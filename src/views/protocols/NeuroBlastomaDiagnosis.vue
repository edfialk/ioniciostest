<template>
  <ion-page>
    ...
    <ion-content
      ...
      scrollY="true"
    >
      <h2 class="ion-text-wrap">Neuroblastoma Diagnosis Algorithm</h2>
  ...
  data() {
    return {
      questions: [
        {
          id: "index",
          title: "Clinical Concern for Neuroblastoma",
          subtitle: `
          ...
          options: [
            {
              label: "Initial Screen: CBC, CMP, urine VMA/HVA, MRI or CT C/A/P",
              jump: "initial",
            },
          ],
        },
        {
          id: "initial",
          title:
            "Findings c/w NBL: Elevated VMA/HVA, adrenal or paraspinous mass on imaging",
          subtitle: `
          ...
          options: [
            {
              label: "No Findings of Metastatic Disease",
              jump: "no metastatic",
            },
            {
              label: "Findings c/w Metastatic Disease",
              jump: "metastatic",
            },
          ],
        },
        {
          id: "no metastatic",
          title: "No Findings of Metastatic Disease",
          options: [
            {
              label: "L1 tumor, age <6-12 mo; size <3-5cm",
              jump: "l1tumor",
            },
            {
              label: "L2 any age or L1 > 12 mo;",
              jump: "l2",
            },
          ],
        },
        {
          id: "l1tumor",
          title: "L1 tumor, age &lt;6-12 mo; size &lt;3-5cm",
          subtitle: `
        ...
        },
        {
          id: "no mets",
          title: "No mets",
          subtitle: "<p>Observe, no biopsy, no resection indicated</p>"
        },
        {
          id: "mets",
          title: "For pathology:",
        ...
        },
        {
          ...
          options: [
            {
              label: "Furger Staging work-up based on pathology and biology",
              jump: "mets"
            }
          ]
        },
        {
          id: "metastatic",
          title: "Findings c/w Metastatic Disease",
          options: [
            {
              label: "Age < 18 mo",
              jump: "age lt 18mo"
        ...
        {
          id: "age lt 18mo",
          title: "Surgical bx of tumor required, 1cm³ tissue",
          subtitle: `
            <p>PLEASE indicate r/o NB in pathology order</p>
          ...
          options: [
            {
              label: "Timeframe for remainder of Staging work-up based on clinical stability and need for treatment initiation",
              jump: "mets"
            }
          ]
        },
        {
          id: "age gt 18mo",
          title: "Surgical bx strongly recommended, 1cm³ tissue.",
          subtitle: `
